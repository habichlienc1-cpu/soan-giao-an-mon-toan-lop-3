...
<div class="main-header">
    ...
    <p>Tác giả: Hà Bích Liên - Trường  Tiểu học Hùng An - ĐT: 0943384572</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hà Bích Liên - Trường Tiểu học Hùng An - ĐT: 0943384572</div>", unsafe_allow_html=True)
